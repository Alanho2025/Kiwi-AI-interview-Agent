...
export const buildCatalogQuestionSnapshots = ({ catalogItems = [], context = {} } = {}) => {
  ...
  ensureArray(catalogItems).forEach((catalogItem) => {
    ...
    items.push({
      ...
      clarificationContextVersion: catalogItem.clarificationContextVersion || catalogItem.ambiguityPolicy?.clarificationContextVersion || null,
      clarificationContext: catalogItem.clarificationContext || (catalogItem.ambiguityPolicy?.clarificationResponseText
