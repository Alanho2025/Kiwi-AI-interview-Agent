export const CAPABILITY_TAXONOMY = {
  ...
  stakeholder_collaboration: ['cross-functional', 'stakeholder', 'stakeholders', 'collaborated', 'worked with', 'communication', 'communicated', 'communicator', 'status updates', 'presented', 'coordinating', 'coordinated', 'co-hosted', 'supported international students', 'client engineers', 'manufacturing engineers', 'product development teams', 'npi builds'],
  troubleshooting: ['defect investigation', 'failure analysis', 'failure pattern', 'root cause', 'production issue', 'debugging', 'troubleshooting', 'test-station issues'],
  problem_solving: ['problem solving', 'problem-solving', 'design of experiments', 'failure analysis', 'identify test-station issues', 'retest rate', 'root cause', 'troubleshooting'],
  attention_to_detail: ['attention to detail', 'dry-run', 'dry run', 'review documents', 'quality checks', 'failure analysis', 'precision'],
