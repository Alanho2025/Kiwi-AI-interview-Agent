...
const HarnessWorkflowRunSchema = new mongoose.Schema(
  {
    ...
    executionMode: { type: String, required: true, enum: ['shadow'], default: 'shadow' },
    ...
    qualityStatus: { type: String, required: true, enum: ['pending', 'valid', 'invalid'] },
    publicationStatus: { type: String, required: true, enum: ['not_applicable'] },
