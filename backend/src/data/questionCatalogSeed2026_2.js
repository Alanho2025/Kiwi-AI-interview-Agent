export const QUESTION_CATALOG_VERSION = '2026.2';
export const CLARIFICATION_CONTEXT_VERSION = '2026.2.v1';
...
const question = ({
  ...
  expectedSignals,
  followUpPolicy: [],
  ambiguityPolicy: { mode: ambiguityMode },
  ...(clarificationResponseText && ambiguityMode !== 'none' ? {
    clarificationContext: { responseText: clarificationResponseText },
    clarificationContextVersion: CLARIFICATION_CONTEXT_VERSION,
  } : {}),
...
export const QUESTION_CATALOG_SEED = [
  ...
  question({
    ...
    clarificationResponseText: 'Select a production feature or system where you had significant ownership over the implementation decision and verification.',
  }),
  question({
  ...
  question({
    ...
    ambiguityMode: 'bounded_scenario',
    clarificationResponseText: 'Focus on a core feature from your recent work or major project where you personally wrote the implementation and automated tests.',
  }),
  question({
  ...
  question({
    ...
    clarificationResponseText: 'You can choose either your daily coding-assistant workflow (e.g. Copilot or Cursor) or a team-level AI feature integration.',
  }),
  question({
    ...
    ambiguityMode: 'bounded_scenario',
    clarificationResponseText: 'Assume a structured JSON output task where system context and edge-case guardrails must be defined for an LLM API.',
  }),
  question({
    ...
    ambiguityMode: 'bounded_scenario',
    clarificationResponseText: 'Assume an enterprise knowledge base RAG system with document access permissions and frequent updates.',
  }),
  question({
    ...
    ambiguityMode: 'bounded_scenario',
    clarificationResponseText: 'Assume an autonomous AI agent with tool-calling capabilities operating in a customer-facing production environment.',
  }),
  question({
    ...
    ambiguityMode: 'bounded_scenario',
    clarificationResponseText: 'Focus on an LLM application undergoing release evaluation where response latency, API cost, and accuracy must be balanced.',
  }),
  question({
    ...
    ambiguityMode: 'bounded_scenario',
    clarificationResponseText: 'Assume a business classification or prediction task where a simple rule-based baseline already exists.',
  }),
  question({
  ...
  question({
    ...
    ambiguityMode: 'bounded_scenario',
    clarificationResponseText: 'Assume a real-time inference model deployed in production where data drift and performance monitoring are required.',
  }),
];
