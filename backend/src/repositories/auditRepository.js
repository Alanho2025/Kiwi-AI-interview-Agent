 ...
 * - Main file role: auditRepository should centralise data access queries so schema changes touch the fewest files possible.
...
/**
 * Purpose: Execute the main responsibility for insertAuditLog.
