...
const summary = await runAgentTrajectoryEval({ datasetPath, reportRoot, thresholds: options, label: 'Agent Trajectory Eval' });

console.log('Agent trajectory eval complete.');
