...
describe('buildCvSignals', () => {
  it('derives role signals from technical skills', () => {
    ...
    expect(signals.roleSignals).toEqual(expect.arrayContaining(['data_profile', 'web_engineering', 'backend_engineering']));
