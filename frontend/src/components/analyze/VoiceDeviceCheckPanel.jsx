 ...
 * - Render microphone and speaker checks inside advanced analysis settings.
 * - Keep status wording close to the user action so voice setup issues are visible before session start.
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-gray-50 p-4">
      <div className="mb-4 flex items-start justify-between gap-4">
        <div>
          <h4 className="text-sm font-semibold text-gray-900">Advanced Voice Settings</h4>
          <p className="mt-1 text-xs text-gray-500">
            Check your microphone before voice interview. Speaker test is recommended but will not block the session.
          </p>
