    ...
    <Card>
      <CardContent className="p-5 space-y-4">
        <div className="flex justify-between items-start">
          <div>
            <h3 className="text-sm font-medium text-faint">Candidate</h3>
            <p className="text-lg font-semibold text-primary">{candidateName}</p>
          </div>
          <div className="px-3 py-1 [background:var(--accent-glow)] text-accent text-xs font-medium rounded-full capitalize">
            {status.replace('_', ' ')}
          </div>
        </div>
        
        <div className="pt-4 border-t border-gray-100">
          <p className="text-sm text-muted">{planPreview || 'Plan: Tailored from CV & JD'}</p>
        </div>
