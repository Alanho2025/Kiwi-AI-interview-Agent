      ...
      <section id="faq" className="relative z-10 border-t py-24 sm:py-32" style={{ borderColor: 'var(--border)', background: 'var(--bg-surface-alt)' }}>
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div>
            ...
            <FAQItem q="What's included in the interview report?" a="Your report includes interview performance, turn-by-turn answer analysis, communication profiling, coaching priorities, answer rewrite suggestions, and evidence diagnostics." />
