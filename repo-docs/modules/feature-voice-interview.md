...
mock-safe tests 在 `backend/tests/robustness/voice`、`backend/tests/integration/voice`、`frontend/src/hooks/__tests__/useVoiceInterviewSession.test.jsx`。Live provider E2E 只能在 Azure/ElevenLabs credentials、browser mic 和 authenticated session 都明确时运行。
